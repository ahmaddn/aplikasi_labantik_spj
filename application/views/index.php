    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
      ...
      <div class="hidden w-full place-items-center lg:grid">
        <div class="w-full max-w-lg p-6">
          <img class="w-full" x-show="!$store.global.isDarkModeEnabled" src="<?= base_url();?>aset/images/illustrations/dashboard-check.svg" alt="image">
          <img class="w-full" x-show="$store.global.isDarkModeEnabled" src="<?= base_url();?>aset/images/illustrations/dashboard-check-dark.svg" alt="image">
        </div>
      </div>
        ...
        <form>
          <div class="mt-16">
            <label class="relative flex">
              <input class="form-input peer w-full rounded-lg bg-slate-150 px-3 py-2 pl-9 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" placeholder="Username" type="text" name="username">
            ...
            <div class="mt-4 text-center text-xs+">
              <p class="line-clamp-1">
                ...
                <a class="text-primary transition-colors hover:text-primary-focus dark:text-accent-light dark:hover:text-accent" href="<?php echo base_url();?>page/register">Create account</a>
              </p>
            </div>
          </div>
        </form>
