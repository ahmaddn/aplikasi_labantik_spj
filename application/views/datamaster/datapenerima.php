                    ...
                    <template x-for="user in usersData" :key="user.id">
                      <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          ...
                          <a class="btn bg-slate-150 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" @click="$notification({text:'Anda Berhasil Menghapus Data!',variant:'info',position:'right-top'})" href="<?php echo base_url();?>penerima/editpenerima/">
                            Edit
                          </a>
                          </div>
                        </td>
